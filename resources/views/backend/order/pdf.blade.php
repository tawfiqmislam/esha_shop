    ...
    <table class="table table-bordered table-stripe">
      ...
      @endphp
        <tr>
          ...
          <td><span>Taka {{number_format($cart->price,2)}}</span></td>
        </tr>
      @endforeach
      </tbody>
      <tfoot>
        <tr>
          ...
          <th scope="col"> <span>Taka {{number_format($order->sub_total,2)}}</span></th>
        </tr>
      ...
      @endif --}}
        ...
        @endphp
        @isset($shipping_charge[0])
          <tr>
            <th scope="col" class="empty"></th>
            <th scope="col" class="text-right ">Shipping:</th>
            <th><span>Taka {{number_format($shipping_charge[0],2)}}</span></th>
          </tr>
        @endisset
        <tr>
          <th scope="col" class="empty"></th>
          ...
          <th>
            <span>
                Taka {{number_format($order->total_amount,2)}}
            </span>
          </th>
        </tr>
      </tfoot>
