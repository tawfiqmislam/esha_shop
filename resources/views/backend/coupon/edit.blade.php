    ...
    <div class="card-body">
      <form method="post" action="{{route('coupon.update',$coupon->id)}}">
        ...
        <div class="form-group">
            ...
            <input id="min_purchase_amount" type="number" name="min_purchase_amount" placeholder="Enter Minimum purchase amount"  value="{{$coupon->min_purchase_amount}}" class="form-control">
